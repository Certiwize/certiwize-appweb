  ...
  try {
    const n8nResp = await fetch(n8nUrl, {
      ...
      body: JSON.stringify({
        id: trainingId,
        ...data
        // Envoie tous les champs {titre}, {maj}, etc.
      })
    });
    const result = await n8nResp.json();
    return new Response(JSON.stringify(result), { status: 200 });
...
// ../.wrangler/tmp/pages-BRc6N0/functionsRoutes-0.6790327050568716.mjs
var routes = [
  {
    routePath: "/api/chat",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-XLmcb7/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-XLmcb7/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7144243164531845.mjs.map
